...
public class MQClientAPIImpl {
    ...
    public SendResult sendMessage(
        ...
        if (isReply) {
            ...
            if (sendSmartMsg || msg instanceof MessageBatch) {
                 ...
                 * @see org.apache.rocketmq.broker.processor.SendMessageProcessor#asyncSendMessage(ChannelHandlerContext, RemotingCommand, org.apache.rocketmq.broker.mqtrace.SendMessageContext, SendMessageRequestHeader)
                 */
    ...
    /**
     * 消息拉取（客户端）
     * 服务端 {@link org.apache.rocketmq.broker.processor.PullMessageProcessor#processRequest(Channel, RemotingCommand, boolean)}
     *
     * @param addr
     * @param requestHeader
     * @param timeoutMillis
     ...
     * @param msg
     * @param consumerGroup
     * @param delayLevel    {@link ConsumeConcurrentlyContext#delayLevelWhenNextConsume}
     * @param timeoutMillis 5000
